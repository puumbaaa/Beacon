...
var _React$createContext = /*#__PURE__*/React.createContext(null),
    Consumer = _React$createContext.Consumer,
    Provider = _React$createContext.Provider;

var HeadTag = /*#__PURE__*/function (_React$Component) {
  _inheritsLoose__default['default'](HeadTag, _React$Component);
  ...
  _proto.render = function render() {
    ...
    var _this$props2 = this.props,
        ...
        rest = _objectWithoutPropertiesLoose__default['default'](_this$props2, ["tag"]);

    var canUseDOM = this.state.canUseDOM;
    return /*#__PURE__*/React.createElement(Consumer, null, function (headTags) {
      if (headTags == null) {
      ...
      if (canUseDOM) {
        ...
        var ClientComp = /*#__PURE__*/React.createElement(Tag, rest);
        return /*#__PURE__*/ReactDOM.createPortal(ClientComp, document.head);
      }

      var ServerComp = /*#__PURE__*/React.createElement(Tag, _extends__default['default']({
        "data-rh": ""
      }, rest));
...
var HeadProvider = /*#__PURE__*/function (_React$Component) {
  _inheritsLoose__default['default'](HeadProvider, _React$Component);
...
var Title = function Title(props) {
  return /*#__PURE__*/React.createElement(HeadTag, _extends__default['default']({
    tag: "title"
  }, props));
};
